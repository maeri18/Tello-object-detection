This contains the python scripts representing the publisher node (camera_publisher.py) and the subscriber node (sub1.py and not camera_subscriber.py) for this project.
